                ...
                <div class="row">
					<div class="col-lg-5 col-md-5 m-b30">
						<div class="bg-primary text-white contact-info-bx">
							...
							<p>Abia State Continuing Teacher Training Centre</p>
							<div class="widget widget_getintuch">	
								<ul>
									<li><i class="ti-location-pin"></i>LAST FLOOR ASUBEB BUILDING, STATE SECRETARIAT OPPOSITE INT'L CONFERENCE CENTER UMUAHIA, ABIA STATE
									</li>
									<li><i class="ti-mobile"></i>08120891240, 07062577778 (24/7 Support Line)</li>
					...
					<div class="col-lg-7 col-md-7">
						<form class="contact-bx ajax-form" action="http://ASCTTC.themetrades.com/demo/assets/script/contact.php">
