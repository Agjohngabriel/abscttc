...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="assets/images/fff.jpeg" />
...
<div id="loading-icon-bx"></div>
		...
		<div class="sticky-header navbar-expand-lg">
            <div class="menu-bar clearfix">
                <div class="container clearfix">
					<!-- Header Logo ==== -->
					<div class="menu-logo">
						<a href="index.php"><img src="assets/images/fff.jpeg" alt="AbSCTTC"></a>
					</div>
					<!-- Mobile Nav Button ==== -->
                        ...
                        <ul class="nav navbar-nav">	
							...
							<li><a href="javascript:;">About<i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
									...
									<li><a href="about-1.html">About Abscott</a></li>
								</ul>
							</li>
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								style="z-index: 7; white-space: nowrap; color:#fff; font-family:rubik; font-size:18px; font-weight:400;">
									Quality Education Expertise Teacher
							</div>
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								style="z-index: 7; white-space: nowrap;text-transform:uppercase; color:#fff; font-family:rubik; font-size:18px; font-weight:400;">
									A great Teacher A great Nation 
							</div>
					...
					<div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
						<div class="item">
							<div class="cours-bx">
								...
								<div class="info-bx text-center">
									<h5><a href="#">Introduction AbSCTTC – LMS plugin</a></h5>
                ...
                <div class="container">
					...
					<div class="testimonial-carousel owl-carousel owl-btn-1 col-12 p-lr0">
						<div class="item">
							<div class="testimonial-bx">
								<div class="testimonial-thumb">
									<img src="assets/images/testimonials/i1.jpeg" alt="">
								</div>
						...
						<div class="item">
							<div class="testimonial-bx">
								<div class="testimonial-thumb">
									<img src="assets/images/testimonials/i2.jpeg" alt="">
								</div>
								<div class="testimonial-info">
									<h5 class="name">Peter Packer</h5>
									<p>-Art Director</p>
    ...
    <footer>
				...
				<div class="container">
					<div class="d-flex align-items-stretch">
						<div class="pt-logo mr-auto">
							<a href="index.php"><!--<img src="assets/images/fff.jpeg" alt="" width="50px"/>--> <h2>AbSCOTT</h2></a>
						</div>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 footer-col-4">
                        <div class="widget">
                            ...
                            <div class="subscribe-form m-b20">
								<form class="subscription-form" action="http://AbSCTTC.themetrades.com/demo/assets/script/mailchamp.php" method="post">
						...
						<div class="row">
							...
							<div class="col-4 col-lg-4 col-md-4 col-sm-4">
								<div class="widget footer_widget">
									...
									<ul>
										<li><a href="http://AbSCTTC.themetrades.com/admin/index.php">Dashboard</a></li>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center"> <a target="_blank" href="#">AbSCTTC</a></div>
                </div>
            </div>
        </div>
    </footer>
